...
//  GourmetSearch
//
//  Created by Kazunari Ueeda on 2018/07/23.
    ...
    var shop: Shop = Shop() {
        didSet {
            ...
            if shop.station != nil {
                ...
                stationX.constant = x
                // ラベルの幅を計算する
                let size = station.sizeThatFits(CGSize(width: CGFloat.greatestFiniteMagnitude, height: CGFloat.greatestFiniteMagnitude))
